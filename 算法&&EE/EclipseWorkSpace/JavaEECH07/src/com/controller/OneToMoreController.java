...
public class OneToMoreController {
	...
	public void test() {
		//查询一个用户及订单信息
		MyUser auser1 = userDao.selectUserOrdersById1(2);
		System.out.println(auser1);
		System.out.println("===================================");
		MyUser auser2 = userDao.selectUserOrdersById2(2);
		System.out.println(auser2);
		System.out.println("===================================");
		List<SelectUserOrdersById> auser3 = userDao.selectUserOrdersById3(2);
